 ...
 * 
 * <p>
 * Cette classe centralise toutes les données partagées entre threads
 * et fournit une synchronisation explicite via des locks.
 * 
 * <h2>Synchronisation</h2>
 * <ul>
 * <li><b>ReadWriteLock</b> : Permet plusieurs lectures simultanées, une seule
 * écriture</li>
